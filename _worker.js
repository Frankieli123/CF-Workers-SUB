...
let urls = [];
let subConverter = "https://sub.nasl.cc:8888/sub"; //在线订阅转换后端，目前使用CM的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
let subConfig = "https://github.com/Frankieli123/clash/blob/main/qichiyu.ini"; //订阅配置文件
